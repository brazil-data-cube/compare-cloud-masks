...
<qgis minScale="1e+08" hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.8.0-Zanzibar" styleCategories="AllStyleCategories">
  ...
  <pipe>
    <rasterrenderer opacity="1" alphaBand="-1" type="paletted" band="1">
      ...
      <colorPalette>
        <paletteEntry color="#440154" label="0 clear - clear land pixel" value="0" alpha="0"/>
        <paletteEntry color="#404387" label="1 clear - clear water pixel" value="1" alpha="0"/>
        <paletteEntry color="#b63ab2" label="2 shadow - cloud shadow" value="2" alpha="255"/>
        <paletteEntry color="#1b896a" label="3 clear - snow" value="3" alpha="0"/>
        <paletteEntry color="#19479d" label="4 cloud - cloud" value="4" alpha="255"/>
        <paletteEntry color="#fde725" label="255" value="255" alpha="255"/>
      </colorPalette>
