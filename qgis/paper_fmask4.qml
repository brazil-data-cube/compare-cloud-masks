...
<qgis maxScale="0" styleCategories="AllStyleCategories" minScale="1e+8" hasScaleBasedVisibilityFlag="0" version="3.4.14-Madeira">
  ...
  <pipe>
    <rasterrenderer type="paletted" alphaBand="-1" band="1" opacity="1">
      ...
      <colorPalette>
        <paletteEntry color="#000000" alpha="255" label="0 clear - clear land pixel"  value="0"/>
        <paletteEntry color="#000000" alpha="255" label="1 clear - clear water pixel" value="1"/>
        <paletteEntry color="#b63ab2" alpha="255" label="2 shadow - cloud shadow"     value="2"/>
        <paletteEntry color="#000000" alpha="255" label="3 clear - snow"              value="3"/>
        <paletteEntry color="#ffffff" alpha="255" label="4 cloud - cloud"             value="4"/>
        <paletteEntry color="#00ff00" alpha="255" label="255"                         value="255"/>
      </colorPalette>
